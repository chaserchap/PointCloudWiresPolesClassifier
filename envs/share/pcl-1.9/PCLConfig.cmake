...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "/home/chapmaca/Projects/pointcloudclassifier/envs/include")
...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "/home/chapmaca/Projects/pointcloudclassifier/envs/include/eigen3" ABSOLUTE)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  find_package(Eigen)
...
macro(find_qhull)
  ...
  elseif(NOT QHULL_ROOT)
    get_filename_component(QHULL_ROOT "/home/chapmaca/Projects/pointcloudclassifier/envs/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
macro(find_ensenso)
  ...
  if(NOT ENSENSO_ROOT AND ("" STREQUAL "TRUE"))
    get_filename_component(ENSENSO_ABI_HINT "" PATH)
  endif()
...
macro(find_davidSDK)
  ...
  if(NOT davidSDK_ROOT AND ("" STREQUAL "TRUE"))
    get_filename_component(DAVIDSDK_ABI_HINT  PATH)
  endif()
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "/home/chapmaca/Projects/pointcloudclassifier/envs/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/conda/feedstock_root/build_artifacts/pcl_1582292915152/work")
